...
RSpec.describe ShortUrlsController, type: :controller do
  ...
  describe "index" do
    ...
    let!(:short_url) { ShortUrl.create(full_url: "https://www.espn.com") }
  ...
  describe "create" do
    ...
    it "creates a short_url" do
      post :create, params: { full_url: "https://www.facebook.com" }, format: :json
    ...
    it "does not create a short_url" do
      ...
      expect(parsed_response['full_url']).to be_include("is not a valid url")
    end
